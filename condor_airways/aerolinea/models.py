...
class Usuario(models.Model):
    ...
    nombres = models.CharField(max_length=150, validators=[solo_letras_espacios], null=True, blank=True)
    apellidos = models.CharField(max_length=150, validators=[solo_letras_espacios], null=True, blank=True)
